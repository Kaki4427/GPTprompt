...
def get_model_response(user_prompt_list, system_prompt, ignore_cache=False, model="gpt-3.5-turbo"):
    if model == "gpt-3.5-turbo":
        ...
        promise = generate_from_openai_chat_completion(user_prompt_list, "gpt-3.5-turbo-0301", system_prompt, API_KEY)
    elif model == "gpt-4":
        print("4")
        promise = generate_from_openai_chat_completion(user_prompt_list, "gpt-4-0301", system_prompt, GPT4_KEY)
