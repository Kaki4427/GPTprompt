...
def generate_prompt_16(positive_examples: List[Dict], negative_examples: List[Dict], validation_set, option='sentences'):
...
def complete_prompts_16(prompt: str, num_examples_to_classify) -> Tuple[List[Dict], float]:
...
def classify_validation_set_16(prompt_list, validation_set, ignore_cache=False):
