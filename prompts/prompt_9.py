...
def get_info_string(sentence_obj):
    ...
    result_string = f"sentence: {sentence}, {verb}, {direct_object}, {preposition}, {prepositional_object}"
    
    return result_string

def generate_prompt_9(positive_examples: List[Dict], negative_examples: List[Dict], validation_set, option='sentences'):
...
def complete_prompts_9(prompt: str, num_examples_to_classify) -> Tuple[List[Dict], float]:
...
def classify_validation_set_9(prompt_list, validation_set, ignore_cache=False):
